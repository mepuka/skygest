...
export class PostsRepo extends Context.Tag("@skygest/PostsRepo")<
  PostsRepo,
  {
    ...
    readonly listRecentByAuthor: (authorDid: string, limit: number) => Effect.Effect<ReadonlyArray<PaperPost>, SqlError>;
    readonly listRecentByAuthors: (authorDids: ReadonlyArray<string>, limit: number) => Effect.Effect<ReadonlyArray<PaperPost>, SqlError>;
