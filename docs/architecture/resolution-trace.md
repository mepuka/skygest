...
The runtime registry is the live source of truth. The fetched snapshot remains the repo-local seed surface, and registry preparation now also builds the shared relationship graph the resolver and typed-search projection both reuse.
